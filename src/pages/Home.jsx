...
function Home() {
    ...
    return (
        <>
            ...
            <div className="w-full bg-[#464F51] text-black py-20 px-8">
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        ...
                        {/* Website Development */}
                        <div className="bg-[#f9f9f9] p-6 rounded-lg shadow-md border border-transparent 
                ...
                transition-all duration-300 ease-in-out">
                        ...
                        {/* Automation */}
                        <div className="bg-[#DEFFF2] p-6 rounded-lg shadow-md border border-transparent 
                hover:shadow-2xl hover:scale-105 hover:border-[#0FF4C6] 
                transition-all duration-300 ease-in-out">
                            <img
                                src={p3}
